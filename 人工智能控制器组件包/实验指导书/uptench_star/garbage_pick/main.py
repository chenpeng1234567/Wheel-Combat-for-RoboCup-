...
class ColorDetect:
    def __init__(self):
        ...
        self.target_y = None
        self.block = False
        self.hold_list = {"green": (160, 180, 100, 255, 100, 255), "yellow": (102, 180, 185, 255, 25, 100)}
        #self.hold_list = {"green": (50, 77, 100, 255, 46, 255), "yellow":  (102, 180, 185, 255, 25, 65)}
