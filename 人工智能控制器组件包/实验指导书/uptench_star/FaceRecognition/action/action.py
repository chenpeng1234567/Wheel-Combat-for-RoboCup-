...
class Controller:
    ...
    def resetAngle(self):
        self.up.CDS_SetAngle(5, 512, 300)
        self.up.CDS_SetAngle(6, 512, 300) 
        self.up.CDS_SetAngle(7, 512, 300)
        self.up.CDS_SetAngle(8, 512, 300)
        self.up.CDS_SetAngle(9, 512, 300)
        self.up.CDS_SetAngle(10, 512, 300)
        self.up.CDS_SetAngle(11, 512, 300)
        self.up.CDS_SetAngle(12, 512, 300)
